...
export class Func extends Term {
  ...
  substitute(variableName, term) {
    ...
    if (variableNameIsArgument || substitutionContainsArgument) {
      //TODO: Do α-reduction: rename the variable of the current function and the body, and then proceed
      //with the substitution
      //TODO: Can be that a child function in a body needs α-reduction as well, recursive process, add a unit test for α-reduction
